...
def feats_to_dim(feats_scp:dict) -> tuple:
    ...
    dimesion is number of features and rest is feature dimensions. Feature
    dimensions is a tuple to account for tensor features. The function is a generator
    
    Input:
        feats_scp .... scp file contianing utt_id and file path
    Output:
